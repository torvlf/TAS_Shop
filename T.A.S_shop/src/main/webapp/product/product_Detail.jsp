...
<html lang="en">
<head>
	<title>T.A.S Store - Products Detail</title>
	<meta charset="utf-8">
	<meta name="viewport"
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="../common/common.jsp">Home <i class="fa fa-chevron-right"></i></a></span> <span><a href="../product/product.jsp">Products <i class="fa fa-chevron-right"></i></a></span> <span>Products Single <i class="fa fa-chevron-right"></i></span></p>
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row">
          	...
          	<p><a href="../order/order.jsp" class="btn btn-primary py-3 px-5 mr-2">Add to Cart</a><a href="../orderdetail/order_detail.jsp" class="btn btn-primary py-3 px-5">Buy now</a></p>
    			</div>
    		</div>
          ...
          <div class="col-md-12 tab-wrap">
            ...
            <div class="tab-content bg-light" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-day-2-tab">
              	<div class="p-4">
	              	<h3 class="mb-4">Manufactured By T.A.S Store</h3>
	              	<p>On her way she met a copy. The copy warned the Little Blind Text, that where it came from it would have been rewritten a thousand times and everything that was left from its origin would be the word "and" and the Little Blind Text should turn around and return to its own, safe country. But nothing the copy said could convince her and so it didnât take long until a few insidious Copy Writers ambushed her, made her drunk with Longe and Parole and dragged her into their agency, where they abused her for their.</p>
              	</div>
              </div>
